...
public class SybaseTableIkrInstanceData extends IkrInstanceData {
	private SybaseTableResult info = null;
	
	public SybaseTableIkrInstanceData(String dbInstance, SybaseTableResult info, Date captureTime) {
	...
	public String getOperations() {
		return String.valueOf(info.getOperations());
	}
	
	public String getLockRequests() {
		return String.valueOf(info.getLockRequests());
	}
	
	public String getLockWaits() {
		return String.valueOf(info.getLockWaits());
	}
}
