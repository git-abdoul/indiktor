...
public abstract class SchedulerConfig implements Serializable{
	...
	public SchedulerConfig(int id, String mode, Calendar startTime, Calendar endTime) {
		this.id = id;
		this.mode = mode;
		...
		if (DAILY.equals(mode)) {
			Date now = new Date(); 
			if (now.before(endTime.getTime()) && now.after(startTime.getTime())) {
