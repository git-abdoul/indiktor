...
public class IkrMonitorSchedulerConfig extends IkrSchedulerConfig implements Serializable{
	...
	public IkrMonitorSchedulerConfig(int id, String type, String mode, Calendar startTime, Calendar endTime , long delay) {
		super(id, mode, startTime, endTime);
		this.type = type;
		this.delay = delay;
	}
	
	public IkrMonitorSchedulerConfig() {
		super();
		this.type = RECURRING;
		this.mode = NONE;
		this.delay = 30;
	...
	public ScheduleIterator getDelayIterator() {
		ScheduleIterator iterator = null;
		if (IkrMonitorSchedulerConfig.RECURRING.equals(type)) {
