...
public class IkrJobSchedulerConfig extends IkrSchedulerConfig implements Serializable{
	private static final long serialVersionUID = 340528474702730336L;
	
	private String name;
	private int jobStaticDomainId;
...
//	private String action;	
	...
	public IkrJobSchedulerConfig(int id, String name, int logicalEnvId, int jobStaticDomainId, String mode, Calendar startTime, Calendar endTime, String description, boolean active) {
		super(id, mode, startTime, endTime);
		this.name = name;
		this.logicalEnvId = logicalEnvId;
		this.jobStaticDomainId = jobStaticDomainId;
//		this.action = action;
	...
	public int getJobStaticDomainId() {
		return jobStaticDomainId;
	}	

	public void setJobStaticDomainId(int jobStaticDomainId) {
		this.jobStaticDomainId = jobStaticDomainId;
	}
