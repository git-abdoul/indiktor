...
CREATE TABLE `TASK_SCHEDULER` (
  ...
  `TASK_STATIC_DOMAIN_ID` bigint(20) NOT NULL,
...
CREATE TABLE `TASK_ATTRIBUTE` (
  `ID` int(10) unsigned NOT NULL auto_increment,
  `TASK_SCHEDULER_ID` int(20) unsigned NOT NULL,
  `NAME` varchar(200) NOT NULL,
  `ATTR_VALUE` varchar(200) default NULL,
  PRIMARY KEY  (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

DROP TABLE IF EXISTS `TASK_STATIC_DOMAIN`;
...
DROP TABLE IF EXISTS `TASK_ATTRIBUTE_CONFIG`;
CREATE TABLE `TASK_ATTRIBUTE_CONFIG` (
  `ID` bigint(20) unsigned NOT NULL auto_increment,
  `TASK_STATIC_DOMAIN_ID` bigint(20) unsigned NOT NULL,
  `NAME` varchar(100) NOT NULL,
  `LABEL` varchar(100) NOT NULL,
  `ENABLE` tinyint(1) default '0',
   PRIMARY KEY  (`ID`)
...
CREATE TABLE `SCHEDULER_TIME` (
  `SCHEDULER_ID` int(20) unsigned NOT NULL,
  ...
  PRIMARY KEY (`SCHEDULER_ID`, `SCHED_TIME_TYPE`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

DROP TABLE IF EXISTS `SCHEDULER_EXEC`;
