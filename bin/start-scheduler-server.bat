...
SET APP_NAME=scheduler-server

SET IKR_JAVA_ARGS=-Dfile.propEnv=%APPLICATION_ENV_PROPERTIES% -Dikr.jdbc.databaseType=%DATABASE_TYPE%
...
%JAVA_CMD% %SCHEDULER_SERVER_JVM_ARGS% %IKR_JAVA_ARGS% com.fsi.scheduler.apps.StartSchedulerServer %1%