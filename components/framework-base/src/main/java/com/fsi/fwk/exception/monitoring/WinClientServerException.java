...
public class WinClientServerException extends WinClientException {
    ...
    public static Hashtable<String, String> errorMessages;

    static 
    {
        errorMessages = null;
        errorMessages = new Hashtable<String,String>(76);
	...
	public WinClientServerException(String message, String type) {
		super(message, type);
		initException(message);
	}

	public WinClientServerException(String message, Throwable cause, String type) {
		super(message, cause, type);
		initException(message);
	}
	
	private void initException(String message) {
		errorCode = null;
        counterName = null;
        errorText = null;
        ...
        {
            counterName = message.substring(0, message.indexOf(" - ERROR: "));
            errorCode = message.substring(message.indexOf(" - ERROR: ") + " - ERROR: ".length() + 2);
